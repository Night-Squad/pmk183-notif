...
public class ViewDashboardHajiController {
	...
	@GetMapping("/readAll")
	public Object viewDashboardUmroh(@RequestParam String kdCabang, @RequestParam String tglAwal, @RequestParam String tglAkhir, @RequestParam Boolean isBjbs, @RequestParam Boolean isKonsolidasi) {
		...
		try {
			...
			else
			{
				...
				{
					long totalMenungguPersetujuanSA = setoranAwalRepository.getCountByStatusTransaksiAndDate(1, dateTglAwal, dateTglAkhir, isBjbs);
					long totalDisetujuiSA = setoranAwalRepository.getCountByStatusTransaksiAndDate(2, dateTglAwal, dateTglAkhir, isBjbs);
					long totalLunasSA = setoranAwalRepository.getCountByStatusTransaksiAndDate(3, dateTglAwal, dateTglAkhir, isBjbs);
					long totalDitolakSA = setoranAwalRepository.getCountByStatusTransaksiAndDate(4, dateTglAwal, dateTglAkhir, isBjbs);
					long totalMenungguReversalSA = setoranAwalRepository.getCountByStatusTransaksiAndDate(6, dateTglAwal, dateTglAkhir, isBjbs);
					long totalTransaksiSA = setoranAwalRepository.getCountBetweenDate(dateTglAwal, dateTglAkhir, isBjbs);
					Long totalNominalMasukSA = setoranAwalRepository.getNominalSetoran(dateTglAwal, dateTglAkhir, isBjbs) == null ? 0 : setoranAwalRepository.getNominalSetoran(dateTglAwal, dateTglAkhir, isBjbs);
					long jumlahNasabahSA = setoranAwalRepository.getCountBetweenDate(dateTglAwal, dateTglAkhir, isBjbs);
					...
					long totalMenungguPersetujuanSP = setoranPelunasanRepository.getCountByStatusTransaksiAndDate(1, dateTglAwal, dateTglAkhir, isBjbs);
					long totalDisetujuiSP = setoranPelunasanRepository.getCountByStatusTransaksiAndDate(2, dateTglAwal, dateTglAkhir, isBjbs);
					long totalLunasSP = setoranPelunasanRepository.getCountByStatusTransaksiAndDate(3, dateTglAwal, dateTglAkhir, isBjbs);
					long totalDitolakSP = setoranPelunasanRepository.getCountByStatusTransaksiAndDate(4, dateTglAwal, dateTglAkhir, isBjbs);
					long totalMenungguReversalSP = setoranPelunasanRepository.getCountByStatusTransaksiAndDate(6, dateTglAwal, dateTglAkhir, isBjbs);
					long totalTransaksiSP = setoranPelunasanRepository.getCountBetweenDate(dateTglAwal, dateTglAkhir, isBjbs);
					Long totalNominalMasukSP = setoranPelunasanRepository.getNominalSetoran(dateTglAwal, dateTglAkhir, isBjbs) == null ? 0 : setoranPelunasanRepository.getNominalSetoran(dateTglAwal, dateTglAkhir, isBjbs);
					long jumlahNasabahSP = setoranPelunasanRepository.getCountBetweenDate(dateTglAwal, dateTglAkhir, isBjbs);
