...
@RestController
@RequestMapping("/api/cetak-resi-setoran-awal")
public class CetakResiSetoranAwalController extends HibernateReportController<SetoranAwal, SetoranAwalDTO> {

    public CetakResiSetoranAwalController(StorageService storageService) {
